...
public class TransitionParser_old {//Transitionの構文解析ツール pastedead cansimulateが重要
	int trNum = 0; // debug
	...
	public TransitionParser_old(List<GameModel> modelList) {
	...
	public TransitionParser_old(List<GameModel> model, ModelInterface controller) {//update時に使ってる
